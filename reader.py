...
if __name__ == '__main__':
    print("coucou")
    file_name = '../data/high_five.bvh'

    b = MyReader(file_name)
    mocap = b.read()
    print("mocap")
    import numpy as np
    print("shape mocap", np.shape(mocap))
    print("shape mocap 0", np.shape(mocap[0]))
    print("shape mocap 1", np.shape(mocap[1]))
    print("shape mocap 2", np.shape(mocap[2]))
    print(mocap[2])
    # print(mocap)
